...
MELCOW_VID = environ.get("MELCOW_VID", "https://unitedcamps.in/Images/IMG_1741018796.jpg")
...
DEENDAYAL_MOVIE_UPDATE_CHANNEL = int(environ.get('DEENDAYAL_MOVIE_UPDATE_CHANNEL', '-1002816348036'))  # Notification of those who verify will be sent to your channel
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1002371780116'))  # Premium logs channel id
auth_channel = environ.get('AUTH_CHANNEL', '-1002386857422')  # Channel/Group ID for force sub (make sure bot is admin)
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1002374738987').split()]
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002386857422')  # Support group id (make sure bot is admin)
...
MULTI_FSUB = [int(channel_id) for channel_id in environ.get('MULTI_FSUB', '-1002386857422 -1002816348036').split() if re.match(r'^-?\d+$', channel_id)]  # Channel for force sub (make sure bot is admin)


# ============================
# Payment Configuration
# ============================
QR_CODE = environ.get('QR_CODE', 'https://unitedcamps.in/Images/IMG_1741019628.jpg')
OWNER_UPI_ID = environ.get('OWNER_UPI_ID', 'dezisingh19@okicici')

# ============================
# MongoDB Configuration
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://dasniru929:dasniru123@cluster0.51p5e.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_URI2 = environ.get('DATABASE_URI2', "mongodb+srv://lokibhai095:lokibhai095@cluster0.69dls.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
HOW_TO_VERIFY = environ.get('HOW_TO_VERIFY', 'https://t.me/How_To_Open_Links_Instant')  # How to open tutorial link for verification
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+W4TIkFt5fZ8zZGQ9')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/Radha_Rani_Backup')
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/PRESIDENTIND7')
DEENDAYAL_MOVIE_UPDATE_CHANNEL_LNK = environ.get('DEENDAYAL_MOVIE_UPDATE_CHANNEL_LNK', 'https://t.me/+W4TIkFt5fZ8zZGQ9')
